...
from Numpy.EsercizioPrestito import FieldParser, RecordValidator, PreprocessingPipeline

#è una lista di dicts in cui chiavi sono stringhe e i valori qualsiasi cosa
